...
@section('content')
    ...
    <div class="container">
        <h2 class="page_title">Creator Center</h2>
            ...
            @if (!empty($offers) && (count($offers) > 1 || $offers[0]->published))
                <div class="grid_columns top_section">
                    ...
                    <div class="text_wrap flex">
                        ...
                        <a href="/creator-center/landing-page/{{$landingPage->id}}">Edit</a>
                    </div>
                </div>
                    ...
                    <li>
                        ...
                        @else
                            <div class="text_wrap flex">
                                ...
                                <span>-</span>
                                <a href="/creator-center/landing-page/{{$landingPage->id}}">(Edit Landing Page)</a>
                    ...
                    <li>
                        ...
                        <div class="text_wrap @if(!empty($offers)) flex @endif">
                            ...
                            @if(!empty($offers))
                                    ...
                                    <span>-</span>
                                    <a href="/creator-center/course/{{$offers[0]->course_id}}">(continue and publish)</a>
                            @endif
                        </div>
                    </li>
                    <li>
