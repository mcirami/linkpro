        ...
        <div class="my_row terms form_page">
            <div class="card guest">
                ...
                <div class="card-body">
                    ...
                    <p>
                        “Premium Plan” refers to a paid plan, with the price dictated in the Order Form. The Premium Plan shall include all the features of the Pro Plan and the Premium Plan, in addition to the availability of up to five (5) unique links and the availability of password protected links. This plan shall also include any other bonus features LinkPro LLC shall choose to add at their discretion.
                    </p>
                    <p>
                    ...
                    <p>
                        “Pro Plan” refers to a paid plan, with the price dictated in the Order Form. The Pro Plan shall include all the features of the Pro Plan in addition to customizable icons and unlimited icons. The amount and nature of said icons shall be subject to change and development by LinkPro LLC.
                    </p>
                    <p>
                        “Services” refers to LinkPro LLC’s products made available to our Users (including their End Users).
                    </p>
                    <p>
                        “Pro Plan” refers to an account providing access to LinkPro LLC’s services free of charge. Said plans include customizable profile and header images, up to nine (9) standard icons, and customizable page link(s), title, and biography.
                    </p>
                    <p>
                    ...
                    <p>
                        Payment for Pro Plans and Premium Plans shall be made in advance and shall renew automatically unless canceled by Users at least one (1) day prior to the term. Excluding one-time discounts and promotional pricing, our price increase will not exceed one-hundred (100) percent. Users are responsible for providing complete and accurate billing and contact information to LinkPro LLC and for updating their accounts if such information changes. A Pro Plan or Premium Plan canceled by a User will automatically convert to a Pro Plan unless you request the deletion of your account.
                    </p>
                    <h4 class="sub_title">5.3 Overdue Charges and Suspension of Service</h4>
                    <p>
                        If Pro Plans or Premium Plans are not canceled as above and payments are not received by the due date, (a) the unpaid balance may accrue interest at the rate of one and a half percent (1.5%) of the outstanding balance per month, or the maximum rate permitted by law, whichever is higher, from the date such payment was due until the date paid; and/or (b) we may condition future Service renewals and Order Form(s) on different payment terms than those specified above. If any amount owed by Users exceeds (X) days overdue, LinkPro LLC may, without limiting our other rights and remedies, accelerate your unpaid fee obligations so that all of your fee obligations become immediately due and payable. We may suspend the Services (including those under the Pro Plan) to you until such amounts are paid in full.
                    </p>
